defmodule TasktrackerSpaWeb.TaskControllerTest do
  ...
  @create_attrs %{body: "some body", complete: true, time_spent: 42, title: "some title"}
  @update_attrs %{body: "some updated body", complete: false, time_spent: 43, title: "some updated title"}
  @invalid_attrs %{body: nil, complete: nil, time_spent: nil, title: nil}
